...
```{r, libraries, error=FALSE, warning=FALSE, cache=TRUE, cache.lazy=FALSE}
library(Seurat)
library(ggplot2)
library(velocyto.R)
...
```{r, setup1, cache=TRUE, cache.lazy=FALSE}
...
```{r, setup2, cache=TRUE, cache.lazy=FALSE}
...
```{r, seurat, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2")}
...
```{r, velocytoSetup, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2")}
...
```{r, filter, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup")}
...
```{r, normalize, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup", "filter")}
vel <- NormalizeData(vel, verbose = FALSE)
vel <- ScaleData(vel, verbose = FALSE)
vel <- RunPCA(vel, features = rownames(vel), verbose = FALSE)
```

```{r, velocityReduction, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup", "filter", "normalize")}
...
```{r, velocityImportPrevious, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup", "filter", "normalize")}
vel_integrated <- vel
...
```{r, runVelocity, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup", "filter", "normalize", "velocityReduction")}
...
```{r, runVelocityIntegrated, cache=TRUE, cache.lazy=FALSE, dependson=c("libraries", "setup1", "setup2", "velocytoSetup", "filter", "normalize", "velocityImportPrevious")}
